CLASS zpp_cl_gen_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zpp_cl_gen_data IMPLEMENTATION.
...
*    me->gen_taxes( ).
  ...
  METHOD gen_country.
    DELETE FROM zpp_d_country.

    INSERT zpp_d_country FROM TABLE @(
      value #(
  ...
  METHOD gen_grod_grp.
    DELETE FROM zpp_d_prod_grp.

    INSERT zpp_d_prod_grp FROM TABLE @(
      VALUE #(
  ...
  METHOD gen_phase.
    DELETE FROM zpp_d_phase.

    INSERT zpp_d_phase FROM TABLE @(
      VALUE #(
  ...
  METHOD gen_uom.
    DELETE FROM zpp_d_uom.

    INSERT zpp_d_uom FROM TABLE @(
      VALUE #(
  ...
  METHOD gen_taxes.
    DELETE FROM zpp_d_tax.

    INSERT zpp_d_tax FROM TABLE @(
      VALUE #(
