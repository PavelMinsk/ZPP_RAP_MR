/********** GENERATED on 06/13/2022 at 09:42:11 by CB9980007940**************/
 ...
 define root abstract entity ZPP_A_CUSTOMER { 
...
//On-condition is not relevant for runtime 
 _CustomerCompany : association [0..*] to ZPP_A_CUSTOMERCOMPANY on 1 = 1; 
 @OData.property.name: 'to_CustomerSalesArea' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _CustomerSalesArea : association [0..*] to ZPP_A_CUSTOMERSALESAREA on 1 = 1; 
 @OData.property.name: 'to_CustomerTaxGrouping' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _CustomerTaxGrouping : association [0..*] to ZPP_A_CUSTOMERTAXGROUPING on 1 = 1; 
 @OData.property.name: 'to_CustomerText' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _CustomerText : association [0..*] to ZPP_A_CUSTOMERTEXT on 1 = 1; 
 } 
