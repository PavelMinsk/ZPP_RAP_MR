/********** GENERATED on 06/13/2022 at 09:42:08 by CB9980007940**************/
 @OData.entitySet.name: 'A_BusinessPartnerAddress' 
 @OData.entityType.name: 'A_BusinessPartnerAddressType' 
 define root abstract entity ZPP_A_BUSINESSPARTNERADDRESS { 
...
//On-condition is not relevant for runtime 
 _AddressUsage : association [0..*] to ZPP_A_BUPAADDRESSUSAGE on 1 = 1; 
 @OData.property.name: 'to_EmailAddress' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _EmailAddress1 : association [0..*] to ZPP_A_ADDRESSEMAILADDRESS on 1 = 1; 
 @OData.property.name: 'to_FaxNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _FaxNumber1 : association [0..*] to ZPP_A_ADDRESSFAXNUMBER on 1 = 1; 
 @OData.property.name: 'to_MobilePhoneNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _MobilePhoneNumber1 : association [0..*] to ZPP_A_ADDRESSPHONENUMBER on 1 = 1; 
 @OData.property.name: 'to_PhoneNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _PhoneNumber1 : association [0..*] to ZPP_A_ADDRESSPHONENUMBER on 1 = 1; 
 @OData.property.name: 'to_URLAddress' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _URLAddress1 : association [0..*] to ZPP_A_ADDRESSHOMEPAGEURL on 1 = 1; 
 } 
