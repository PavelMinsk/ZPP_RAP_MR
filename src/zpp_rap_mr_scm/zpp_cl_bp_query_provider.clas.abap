CLASS zpp_cl_bp_query_provider DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_business_partner_range TYPE RANGE OF ZPP_A_BUSINESSPARTNER-BusinessPartner.
    TYPES t_business_data          TYPE TABLE OF ZPP_A_BUSINESSPARTNER.
...
CLASS zpp_cl_bp_query_provider IMPLEMENTATION.
  METHOD get_business_partners.
    ...
    service_consumption_name = to_upper( 'ZPP_SC_BUSINESS_PARTNER' ).
    ...
    read_list_request = odata_client_proxy->create_resource_for_entity_set(
                                              'A_BUSINESSPARTNER'
