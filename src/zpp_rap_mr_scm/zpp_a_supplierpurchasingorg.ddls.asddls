/********** GENERATED on 06/13/2022 at 09:42:26 by CB9980007940**************/
 @OData.entitySet.name: 'A_SupplierPurchasingOrg' 
 @OData.entityType.name: 'A_SupplierPurchasingOrgType' 
 define root abstract entity ZPP_A_SUPPLIERPURCHASINGORG { 
...
//On-condition is not relevant for runtime 
 _PartnerFunction1 : association [0..*] to ZPP_A_SUPPLIERPARTNERFUNC on 1 = 1; 
 @OData.property.name: 'to_PurchasingOrgText' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _PurchasingOrgText : association [0..*] to ZPP_A_SUPPLIERPURCHASINGORGTEX on 1 = 1; 
 } 
