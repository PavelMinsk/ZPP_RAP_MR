/********** GENERATED on 06/13/2022 at 09:42:16 by CB9980007940**************/
 @OData.entitySet.name: 'A_CustomerSalesArea' 
 @OData.entityType.name: 'A_CustomerSalesAreaType' 
 define root abstract entity ZPP_A_CUSTOMERSALESAREA { 
...
//On-condition is not relevant for runtime 
 _PartnerFunction : association [0..*] to ZPP_A_CUSTSALESPARTNERFUNC on 1 = 1; 
 @OData.property.name: 'to_SalesAreaTax' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SalesAreaTax : association [0..*] to ZPP_A_CUSTOMERSALESAREATAX on 1 = 1; 
 @OData.property.name: 'to_SalesAreaText' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SalesAreaText : association [0..*] to ZPP_A_CUSTOMERSALESAREATEXT on 1 = 1; 
 } 
