/********** GENERATED on 06/13/2022 at 09:42:04 by CB9980007940**************/
 ...
 define root abstract entity ZPP_A_BPCONTACTTOADDRESS { 
...
//On-condition is not relevant for runtime 
 _EmailAddress : association [0..*] to ZPP_A_ADDRESSEMAILADDRESS on 1 = 1; 
 @OData.property.name: 'to_FaxNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _FaxNumber : association [0..*] to ZPP_A_ADDRESSFAXNUMBER on 1 = 1; 
 @OData.property.name: 'to_MobilePhoneNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _MobilePhoneNumber : association [0..*] to ZPP_A_ADDRESSPHONENUMBER on 1 = 1; 
 @OData.property.name: 'to_PhoneNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _PhoneNumber : association [0..*] to ZPP_A_ADDRESSPHONENUMBER on 1 = 1; 
 @OData.property.name: 'to_URLAddress' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _URLAddress : association [0..*] to ZPP_A_ADDRESSHOMEPAGEURL on 1 = 1; 
 } 
