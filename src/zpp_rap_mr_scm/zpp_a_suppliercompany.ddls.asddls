/********** GENERATED on 06/13/2022 at 09:43:18 by CB9980007940**************/
 @OData.entitySet.name: 'A_SupplierCompany' 
 @OData.entityType.name: 'A_SupplierCompanyType' 

/*+[hideWarning] { "IDS" : [ "CARDINALITY_CHECK" ] }*/
 define root abstract entity ZPP_A_SUPPLIERCOMPANY { 
...
//On-condition is not relevant for runtime 
 _CompanyText1 : association [0..*] to ZPP_A_SUPPLIERCOMPANYTEXT on 1 = 1; 
 @OData.property.name: 'to_Supplier' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Supplier1 : association [1] to ZPP_A_SUPPLIER on 1 = 1; 
 @OData.property.name: 'to_SupplierDunning' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SupplierDunning : association [0..*] to ZPP_A_SUPPLIERDUNNING on 1 = 1; 
 @OData.property.name: 'to_SupplierWithHoldingTax' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SupplierWithHoldingTax : association [0..*] to ZPP_A_SUPPLIERWITHHOLDINGTAX on 1 = 1; 
 } 
