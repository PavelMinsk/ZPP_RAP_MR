/********** GENERATED on 06/13/2022 at 09:42:12 by CB9980007940**************/
 @OData.entitySet.name: 'A_CustomerCompany' 
 @OData.entityType.name: 'A_CustomerCompanyType' 
 define root abstract entity ZPP_A_CUSTOMERCOMPANY { 
...
//On-condition is not relevant for runtime 
 _CompanyText : association [0..*] to ZPP_A_CUSTOMERCOMPANYTEXT on 1 = 1; 
 @OData.property.name: 'to_CustomerDunning' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _CustomerDunning : association [0..*] to ZPP_A_CUSTOMERDUNNING on 1 = 1; 
 @OData.property.name: 'to_WithHoldingTax' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _WithHoldingTax : association [0..*] to ZPP_A_CUSTOMERWITHHOLDINGTAX on 1 = 1; 
 } 
