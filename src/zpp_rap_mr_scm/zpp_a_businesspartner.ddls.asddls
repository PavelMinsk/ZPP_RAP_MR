/********** GENERATED on 06/13/2022 at 09:43:15 by CB9980007940**************/
 @OData.entitySet.name: 'A_BusinessPartner' 
 @OData.entityType.name: 'A_BusinessPartnerType' 

/*+[hideWarning] { "IDS" : [ "CARDINALITY_CHECK" ] }*/
 define root abstract entity ZPP_A_BUSINESSPARTNER { 
...
//On-condition is not relevant for runtime 
 _BuPaIdentification : association [0..*] to ZPP_A_BUPAIDENTIFICATION on 1 = 1; 
 @OData.property.name: 'to_BuPaIndustry' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BuPaIndustry : association [0..*] to ZPP_A_BUPAINDUSTRY on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerAddress' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerAddress : association [0..*] to ZPP_A_BUSINESSPARTNERADDRESS on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerBank' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerBank : association [0..*] to ZPP_A_BUSINESSPARTNERBANK on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerContact' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerContact : association [0..*] to ZPP_A_BUSINESSPARTNERCONTACT on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerRole' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerRole : association [0..*] to ZPP_A_BUSINESSPARTNERROLE on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerTax' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerTax : association [0..*] to ZPP_A_BUSINESSPARTNERTAXNUMBER on 1 = 1; 
 @OData.property.name: 'to_Customer' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Customer : association [1] to ZPP_A_CUSTOMER on 1 = 1; 
 @OData.property.name: 'to_Supplier' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Supplier : association [1] to ZPP_A_SUPPLIER on 1 = 1; 
 } 
