/********** GENERATED on 06/13/2022 at 09:42:23 by CB9980007940**************/
 @OData.entitySet.name: 'A_Supplier' 
 @OData.entityType.name: 'A_SupplierType' 
 define root abstract entity ZPP_A_SUPPLIER { 
...
//On-condition is not relevant for runtime 
 _SupplierCompany : association [0..*] to ZPP_A_SUPPLIERCOMPANY on 1 = 1; 
 @OData.property.name: 'to_SupplierPurchasingOrg' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SupplierPurchasingOrg : association [0..*] to ZPP_A_SUPPLIERPURCHASINGORG on 1 = 1; 
 @OData.property.name: 'to_SupplierText' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SupplierText : association [0..*] to ZPP_A_SUPPLIERTEXT on 1 = 1; 
 } 
