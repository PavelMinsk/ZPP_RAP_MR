CLASS zpp_cl_suppliers DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: mty_t_suppliers TYPE STANDARD TABLE OF zpp_suppliers.
...
CLASS zpp_cl_suppliers IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    DATA: lt_business_data    TYPE mty_t_suppliers,
          lt_business_data_ce TYPE TABLE OF zpp_suppliers_c,
          lt_suppladd         TYPE STANDARD TABLE OF zpp_d_suppladd.
    ...
    TRY.
        ...
        IF lt_business_data_ce IS NOT INITIAL.
          SELECT * FROM zpp_d_suppladd FOR ALL ENTRIES IN @lt_business_data_ce
  ...
  METHOD get_client_proxy.
    ...
    io_client_proxy = cl_web_odata_client_factory=>create_v4_remote_proxy(
      EXPORTING
        iv_service_definition_name = 'ZPP_SC_SUPPLIERS'
